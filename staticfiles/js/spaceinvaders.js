...
WelcomeState.prototype.enter = function(game) {
    ...
    // Use the passed URLs from the template.
    game.sounds.loadSound('shoot', shootSoundUrl);
    game.sounds.loadSound('bang', bangSoundUrl);
    game.sounds.loadSound('explosion', explosionSoundUrl);
};
